...
const ja = {
  ...
  historySub: 'HISTORY',
  historyTitle: '着用履歴',
  heavyRotation: '今月のヘビロテ',
  noHeavyRotation: 'まだ記録がありません',
  noHistoryText: '着用履歴がありません\n+ボタンから記録しましょう',
  timesThisMonth: (n: number) => `今月${n}回着用`,
  recordToday: '今日の着用を記録',
  wornItems: '着用した服（複数選択可）',
  tpoLabel: 'TPO',
  saveRecord: '記録する',
  selectClothes: '服を選んでください',
  ...
  editRecord: '記録を編集',
  saveChanges: '変更を保存',
  deleteRecordConfirm: 'この着用履歴を削除しますか？',
  signOut: 'サインアウト',
...
const en: typeof ja = {
  ...
  heavyRotation: 'Most Worn This Month',
  noHeavyRotation: 'No records yet',
  noHistoryText: 'No wear history yet.\nTap + to start recording.',
  timesThisMonth: (n: number) => `Worn ${n}x this month`,
  recordToday: "Record Today's Outfit",
  wornItems: 'Items worn (multi-select)',
  tpoLabel: 'Occasion',
  saveRecord: 'Save Record',
  selectClothes: 'Please select items',
  settingsSub: 'SETTINGS',
  ...
  deleteRecordConfirm: 'Delete this wear record?',
  signOut: 'Sign Out',
